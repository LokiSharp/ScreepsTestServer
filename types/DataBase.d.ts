...
export interface DBRoomTerrain {
  _id?: string;
  room?: string;
  terrain?: string;
  type?: string;
...
export interface DBUserPowerCreep {
  _id?: string;
  name?: string;
  className?: string;
  user?: string;
...
export interface DBUserConsole {
  _id?: string;
  user?: string;
  expression?: string;
  hidden?: boolean;
